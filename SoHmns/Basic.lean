...
/--
  ...
  임의의 유동 상태 실수 `x`와 제어 장벽 `y`에 대하여, 비선형 순서체 추론 코어인
...
/--
  ...
  시공간 변분에 따른 유체의 실제 역학적 변분 에너지 `E_fluid`와 제어 장벽 에너지 `E_barrier`가
...
/--
  ...
  완전제곱식 Confinement 하반연속 정리를 알고리즘 복잡도 위계에 사상하여,
...
/--
  ...
  대수 격벽 공리를 상속받아, 진공 기저 상태 위로 항상 절대적인 질량 간극 
